...
angular.module("getbookmarks", ["getbookmarks.services"]).
    config(function ($routeProvider) {
        $routeProvider
            .when('/', {templateUrl: 'views/list.html', controller: StoryListController})
            .when('/stories/new', {templateUrl: 'views/create.html', controller: StoryCreateController})
            .when('/stories/:storyId', {templateUrl: 'views/detail.html', controller: StoryDetailController});
    });
